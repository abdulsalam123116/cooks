    ...
    render(){
        return(
            <div className='backgroundFrame'>
                <div className='title'>
                <div> <img className="imageMatched" src="https://en.akinator.com/bundles/elokencesite/images/akitudes_670x1096/defi.png"/> </div>
                    <div className='mainTitle'>
                    Hello, I am Matched
                    </div>
                    <h1>Think about a cook.I will try to guess it</h1>
